    ...
    <div id="about">
      ...
      <div className="max-w-[90%] md:max-w-[80%] mx-auto mt-20 md:mt-40">
        <div className="flex flex-col justify-center items-center mt-6">
          ...
          <h1 className="font-extrabold text-4xl md:text-5xl text-gray-700 border-l-4 md:border-l-6 border-b-2 border-gray-900 px-3">
            Meet Me
          </h1>
        ...
        <div>
          ...
          <div className="flex justify-center pt-10 md:pt-16 text-2xl sm:text-3xl md:text-4xl font-semibold text-[#252B46] mb-8 md:mb-12">
            <h1>
              My <span className="text-gray-700">Experience</span>
            </h1>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-stretch gap-6 md:gap-12 max-w-4xl mx-auto px-4">
            ...
            <div className="w-full md:w-1/2 bg-gray-50 p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
              <div>
                <h2 className="font-bold text-lg md:text-[20px] text-[#252B46]">
                  Trainee & Peer Mentor at Softzenith (Ascend Bootcamp)
                </h2>
              </div>
              <p className="text-gray-500 text-sm md:text-[16px] mt-4 font-medium">
                Feb, 2026 - Present
              </p>
            </div>
