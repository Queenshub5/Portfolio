...
export default function ContactPage() {
  ...
  return (
    ...
    <div className="flex flex-col items-center py-16 px-4 mt-12 md:mt-24">
     <h1 className="font-extrabold text-5xl text-gray-700 border-l-6 border-b-2 border-gray-900 dark:border-blue-500 dark:text-blue-500 px-3 mb-4" id="contact"> Contact</h1>
